...
struct DslashFusedPackFusedHalo : DslashPolicyImp<Dslash> {
  ...
  static DslashPolicyImp<Dslash>* create(const QudaDslashPolicy &dslashPolicy)
  {
    ...
    case QudaDslashPolicy::QUDA_FUSED_ZERO_COPY_DSLASH:
      ...
      break;
    case QudaDslashPolicy::QUDA_DSLASH_FUSED_PACK:
      result = new DslashFusedPack<Dslash>;
      break;
    case QudaDslashPolicy::QUDA_DSLASH_FUSED_PACK_FUSED_HALO:
      result = new DslashFusedPackFusedHalo<Dslash>;
      break;
